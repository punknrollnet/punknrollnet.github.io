...
text = suicide_note.toLowerCase().replace(/"'"/g, '').replace(/\W+/g, ' ').replace(/\s{2,}/g, ' ').trim();
...
fontSize = d3.scale.linear().range([min, max * 1.8]), w = 1080, h = 800, offset = 1.4, svg = null, g = null;
